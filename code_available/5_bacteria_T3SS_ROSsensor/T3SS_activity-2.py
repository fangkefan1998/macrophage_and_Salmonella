...
img = cv2.imread("E:\\Documents\\Python\\Data\\psicA-activity\\488\\488-pbs-2.tif")
...
imraw = matplotlib.image.imread('E:\\Documents\\Python\\Data\\psicA-activity\\488\\488-pbs-2.tif')
...
for k in range(0, storage.__len__()):
    ...
    if s == 1:
        path = "E:\\Documents\\Python\\Data\\psicA-activity\\foci\\" + str(k) + "foci.png"
        ...
        path = "E:\\Documents\\Python\\Data\\psicA-activity\\even\\" + str(k) + "even.png"
        single_normal = normalization.normalize(single)
        im = Image.fromarray(single_normal * 255.0)
        im.convert('L').save(path)
...
img405 = matplotlib.image.imread("E:\\Documents\\Python\\Data\\psicA-activity\\405\\405-pbs-2.tif")
...
foci_output.to_csv("E:\\Documents\\Python\\Data\\psicA-activity\\psicA_h2o2Foci_intensity.csv", encoding="gbk")

even_output = pd.DataFrame(data=even_intensity)
even_output.to_csv("E:\\Documents\\Python\\Data\\psicA-activity\\psicA_h2o2Even_intensity.csv", encoding="gbk")
