...
img = cv2.imread("D:\\Foci_Identify\\T3SS_new\\ssrA\\ssrA-488-2.tif")
...
imraw = matplotlib.image.imread('D:\\Foci_Identify\\T3SS_new\\ssrA\\ssrA-488-2.tif')
...
img405 = matplotlib.image.imread("D:\\Foci_Identify\\T3SS_new\\ssrA\\ssrA-405-2.tif")
...
foci_output.to_csv("D:\\Foci_Identify\\prgh_3h\\Data\\result\\Foci_intensity-ssrA2.csv", encoding="gbk")

even_output = pd.DataFrame(data=even_intensity)
even_output.to_csv("D:\\Foci_Identify\\prgh_3h\\Data\\result\\Even_intensity-ssrA2.csv", encoding="gbk")
